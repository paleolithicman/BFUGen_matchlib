...
sc_biguint<256> str2biguint(string data) {
    sc_biguint<256> res;
...
// #pragma hls_pipeline_init_interval 1
            do {
                ...
                primate_stream_256_4::payload_t payload(str2biguint(indata), i, empty, last);
...
public:
    ...
    primate_stream_256_4::chan<>        CCS_INIT_S1(tb_to_dut_data);
    primate_stream_256_4::chan<>        CCS_INIT_S1(dut_to_tb_data);
